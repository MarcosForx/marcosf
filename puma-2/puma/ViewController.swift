...
class ViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    @IBAction func boton8(_ sender: UIButton) {
...
////FIN RUTA 4
    ...
    @IBAction func button11(_ sender: UIButton) {
        ...
        let baseMarket = MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 19.323676, longitude: -99.187971))
        let abajoDelPutoPuente = MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 19.330456952111433, longitude: -99.18903819458063))
         let anotherPoint = MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 19.331264741528884, longitude: -99.1898184064323))
        let yaCasi = MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 19.331194871703076, longitude: -99.18988884799545))
        let obrasMarket = MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 19.3350216, longitude: -99.1929935))
        let estadio7Market = MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 19.329129, longitude: -99.192346))
        let campoMarket = MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 19.3232688, longitude: -99.1922320))
        let campoPunto = MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 19.325083, longitude:  -99.189017))
         let estadioMarket = MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 19.3268006, longitude: -99.1880615) )
        
        // linea 1
        let directionRequest = MKDirectionsRequest()
        directionRequest.source = MKMapItem(placemark: baseMarket)
        directionRequest.destination = MKMapItem(placemark: estadioMarket)
        directionRequest.transportType = .automobile
        let direction = MKDirections(request: directionRequest)
        direction.calculate {
            (response, error) in guard let directionResonse = response else {
        ...
        //linea 2
        let directionRequest1 = MKDirectionsRequest()
        directionRequest1.source = MKMapItem(placemark: estadioMarket)
        ...
        //linea 3
        let directionRequest2 = MKDirectionsRequest()
        directionRequest2.source = MKMapItem(placemark: abajoDelPutoPuente)
        directionRequest2.destination = MKMapItem(placemark: anotherPoint)
        directionRequest2.transportType = .automobile
        ...
        //linea 4
        let directionRequest3 = MKDirectionsRequest()
        directionRequest3.source = MKMapItem(placemark: anotherPoint)
        directionRequest3.destination = MKMapItem(placemark:yaCasi)
        ...
        //linea 5
        let directionRequest4 = MKDirectionsRequest()
        directionRequest4.source = MKMapItem(placemark: yaCasi)
        directionRequest4.destination = MKMapItem(placemark: obrasMarket)
        directionRequest4.transportType = .automobile
        ...
        //linea 6
        let directionRequest5 = MKDirectionsRequest()
        directionRequest5.source = MKMapItem(placemark: obrasMarket)
        directionRequest5.destination = MKMapItem(placemark: campoMarket)
        directionRequest5.transportType = .automobile
        ...
        //linea 7
        let directionRequest6 = MKDirectionsRequest()
        directionRequest6.source = MKMapItem(placemark: campoMarket)
        directionRequest6.destination = MKMapItem(placemark: campoPunto)
        directionRequest6.transportType = .walking
        ...
        //linea 7
        let directionRequest7 = MKDirectionsRequest()
        directionRequest7.source = MKMapItem(placemark: campoPunto)
        directionRequest7.destination = MKMapItem(placemark: baseMarket)
        directionRequest7.transportType = .walking
        
        let direction7 = MKDirections(request: directionRequest7)
        direction7.calculate {
            (response, error) in guard let directionResonse7 = response else {
                if let error = error {
                    print("error")
                }
                return
            }
            let route7 = directionResonse7.routes[0]
            self.mapa.add(route7.polyline, level: .aboveRoads)
            let rect7 = route7.polyline.boundingMapRect
            self.mapa.setRegion(MKCoordinateRegionForMapRect(rect7), animated: true)
        var color = UIColor.blue.withAlphaComponent(0.5)
        }
        // ruta 6
